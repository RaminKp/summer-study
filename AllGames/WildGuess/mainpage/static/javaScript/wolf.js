...
//Example trait list
const correctTraitList = ['Vocal communication', 'Depth perception', 'Thick fur', 'Resiliant stomach', 'Sharp teeth', 'Good sense of smell'];
...
function onPageLoad(){
    ...
    let hoverSound = new Audio("/static/sounds/wolf.mp3"); // Replace with your actual sound file path
