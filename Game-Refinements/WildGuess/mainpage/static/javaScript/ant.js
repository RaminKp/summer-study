  const traitList = [
    "have a strong outer shell",               // correct (exoskeleton)
    "can survive extreme conditions",     // correct (extreme conditions)
    "talk by making loud noises",              // incorrect
    "usually live in flower pots",             // incorrect
    "have a queen that lays all the eggs",     // correct
    "love to swim in water",                   // incorrect
    "can form supercolonies",        // correct (supercolonies)
    "always have four wings",                  // incorrect
    "make tunnels and homes underground",      // correct (complex structures)
    "can change their color",  // incorrect
    "come out only at night",                  // incorrect
    "have specialized workers"   // correct (specialized workers)
  ];
  
  // Correct traits array
  const correctTraitList = [
    "have a strong outer shell",
    "can survive extreme conditions",
    "have a queen that lays all the eggs",
    "can form supercolonies",
    "make tunnels and homes underground",
